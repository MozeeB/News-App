...
import com.cikup.news.utils.Dimens
import com.cikup.news.utils.Dimens.MediumPadding1

fun Modifier.shimmerEffect(cornerRange: CornerRadius = CornerRadius(12f, 12f)) = composed {
    ...
    val color = colorResource(id = R.color.teal_700).copy(alpha)
    drawBehind {
        drawRoundRect(
            color = color,
            cornerRadius = cornerRange,
        )
    }
}
